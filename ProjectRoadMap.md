# SweetMatch Project Roadmap

## Sprint 1:
- [x] Create GitHub team and repository in KSU-IS organization
- [x] Add and edit README.md file
- [x] Research related code (Mood Movie project)
- [x] Clone Mood Movie repository
- [x] Test Mood Movie code locally and document issues or setup steps
...
Running the code, I encountered some problems. There was a list of emotions, but only some of the emotions in the code actually worked. Emotions like "bored", "stressed", or "angry" would output that the code didn't have any recommendations for my mood. Emotions like "happy", "excited", and "romantic" worked though. The original Mood Movie code is mostly static since it outputs a full list of recommendations for the emotions that do work. There is overlapping logic in the code: two separate data structures (emotion_to_genre + genre_to_movies vs. movies_by_mood) and two separate functions essentially do the same task, which can be confusing and limits flexibility.
